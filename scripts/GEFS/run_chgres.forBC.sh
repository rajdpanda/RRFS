...
FIXDIR=/lustre/ensemble/20210303/stmp1/2
MEMBER_DOWNLOAD=/lustre/ensemble/20210303/download/2
date_prv=20210302
hour_from=18
GEP_NUM=01
beg_hour=6
...
WORKDIR=/lustre/ensemble/20210303/stmp1/2/chgres_fv3.forBC.grib2.c3357
rm -fr $WORKDIR
mkdir -p $WORKDIR
cd $WORKDIR
#
...
&config
 ...
 grib2_file_input_grid="gep${GEP_NUM}.t${hour}z.pgrb2b.0p50.f${hour_name}"
...
#
# create namelist and run chgres_cube to create IC file
#
chour=${beg_hour}
fhour=`expr $chour - 6`
hour_name='00'$chour
